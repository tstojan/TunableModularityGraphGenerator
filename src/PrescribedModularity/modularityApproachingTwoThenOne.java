...
public class modularityApproachingTwoThenOne {
	...
	public modularityApproachingTwoThenOne(int _L, int _c, double _M, double _t) throws IOException
	{
		L = _L;
		c = _c;
		M = _M;
		...
		System.out.println("------------------------ StartShifting --------------------------");
		System.out.println();
